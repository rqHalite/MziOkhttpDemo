...
import com.rock.okhttp3_demo.bean.PageBean;
import com.rock.okhttp3_demo.utils.anim.AlphaInAnimation;
import com.rock.okhttp3_demo.utils.anim.BaseAnimation;
import com.rock.okhttp3_demo.utils.helper.ViewHolderHelper;
import com.rock.okhttp3_demo.utils.listener.DataIO;
import com.rock.okhttp3_demo.utils.listener.OnItemClickListener;
...
public abstract class CommonRecycleViewAdapter<T>  extends RecyclerView.Adapter<ViewHolderHelper> implements DataIO<T> {
    ...
    @Override
    public void notifyData(List<T> elements) {
        this.mDatas = elements;
        notifyDataSetChanged();
    }
